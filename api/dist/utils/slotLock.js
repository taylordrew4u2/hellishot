...
function calculateApproximateTime(slotNumber, eventStartTime) {
...
export async function assignSlotAndCreateBooking({ event_id, block, user_name, performance_type, song_info, wants_video, payment_method, payment_status, device_id }) {
